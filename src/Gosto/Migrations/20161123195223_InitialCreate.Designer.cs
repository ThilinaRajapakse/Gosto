...
namespace Gosto.Migrations
{
    ...
    [Migration("20161123195223_InitialCreate")]
    partial class InitialCreate
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Gosto.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Gosto.Models.Promotion", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Gosto.Models.ShoppingCart", b =>
                {
                    b.Property<string>("ID");
            ...
            modelBuilder.Entity("Gosto.Models.ApplicationUser", b =>
                {
                    b.HasOne("Gosto.Models.ShoppingCart")
                        .WithOne()
                        .HasForeignKey("Gosto.Models.ApplicationUser", "ShoppingCartID");
                });
            ...
            modelBuilder.Entity("Gosto.Models.Order", b =>
                {
                    b.HasOne("Gosto.Models.ApplicationUser")
                        .WithMany()
